...
```
 Il teorema del campionamento è stata formulata da shannon, la sua formula è fc>2fmax e serve, appunto, a campionare un suono o , per esempio, a calcolare quante volte un avvenimento ciclico avviene in un determinato lasso di tempo
```
...
```
fc>2fmax= 32000>2fmax= 32000/(2)-1= 15999
```
...
```
880*7= 6160   fc>2fmax   6160>2fmax   6160*(2)+1= 12321
```
